			...
			<div class="container-fluid no-padding bg-dark">
				...
				<div class="owl-carousel cc-height-full cursor-grab nav-bottom-right" data-items="1" data-loop="true"
					...
					<div class="cc-item bg-image"
						style="background-image: url(assets/img/gallery/gallery-list/slideshow/gallery-slideshow-5.jpg); background-position: 50% 30%;">
					...
					<!-- Begin carousel item 
						========================= -->
					<div class="cc-item bg-image"
						style="background-image: url(assets/img/gallery/gallery-list/slideshow/gallery-slideshow-6.jpg); background-position: 50% 50%;">
					...
					<!-- Begin carousel item 
						========================= -->
					<div class="cc-item bg-image"
						style="background-image: url(assets/img/gallery/gallery-list/slideshow/gallery-slideshow-7.jpg); background-position: 50% 50%;">
					...
					<!-- Begin carousel item 
						========================= -->
					<div class="cc-item bg-image"
						style="background-image: url(assets/img/gallery/gallery-list/slideshow/gallery-slideshow-8.jpg); background-position: 50% 50%;">
